...
<head>
    <meta charset="utf-8" />
    <title>LATIHAN </title>
    <meta name="description" content="latihan codeigniter lintang yoni" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Accounting</span>
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Administration</span>
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Projects</span>
                                        ...
                                        <div class="col-6">
                                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
                                                <span class="svg-icon svg-icon-3x svg-icon-success">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span> <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">Customers</span>
                ...
                <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="d-flex flex-column-fluid">
                        <!--begin::Container disini-->
                        <div class=" container ">

                            <div class="card card-custom">
                                <div class="card-body">
                                    <h4 class="text-center">KERJAKAN <span class="text-danger">YACH!</span></h4>
                                    ...
                                    <div class="timeline timeline-5 mt-3">
                                        ...
                                        <div class="timeline-item align-items-start">
                                            ...
                                            <div class="font-weight-mormal font-size-lg timeline-content pl-3">
                                                Buat C-R-U-D menggunakan <b>ajax</b>
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Item-->
                                        ...
                                        <div class="timeline-item align-items-start">
                                            ...
                                            <!--begin::Text-->
                                            <div class="font-weight-mormal font-size-lg timeline-content pl-3">
                                                Buat C-R-U-D menggunakan <b>Form Modal</b>
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Item-->
                                        ...
                                        <div class="timeline-item align-items-start">
                                            ...
                                            <!--begin::Text-->
                                            <div class="font-weight-mormal font-size-lg timeline-content pl-3">
                                                Pada <i>dataTable</i> dibawah, kolom <b>STATUS</b> harus memiliki kondisi <span class="label label-lg label-light-primary label-inline">aktif</span> dan <span class="label label-lg label-light-danger label-inline">non-aktif</span> ketika data dihapus.
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Item-->
                                        ...
                                        <div class="timeline-item align-items-start">
                                            ...
                                            <!--begin::Text-->
                                            <div class="font-weight-mormal font-size-lg timeline-content pl-3">
                                                Pada <i>dataTable</i> dibawah, kolom <b>ACTION</b> harus memiliki kondisi <i class="fas fa-trash-alt text-danger"></i> pada saat status aktif, dan <i class="fas fa-lock-open text-success"></i> ketika data dihapus.
                                            </div>
                                            <!--end::Text-->
                                        </div>
                                        <!--end::Item-->
                            ...
                            <div class="card card-custom">
                                <div class="card-body">
                                    <div class="text-right">
                                        <button type="button" class="btn btn-default btn-primary" title="Add new data"><i class="fas fa-plus-square"></i> Add</button>
    ...
    <script type="text/javascript" src="assets/js/crud_operation.js"></script>
    <script>
