...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
                            ...
                            <div class="card card-custom">
                                <div class="card-body">
                                    <div class="text-right">
                                        ...
                                        <button data-toggle="modal" data-target="#addModal" class="btn btn-default btn-primary"><i class="fas fa-plus-square"></i>Add</button>
                                            ...
                                            <tbody id="tbl_data">
                                                ...
                                                foreach ($user as $a) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $a['username'] ?></td>
                                                        <td><?= $a['role'] ?></td>
                                                        <td><img src="<?= $a['photo'] ?>" alt="test"></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-icon btn-default btn-xs" title="Actived dona"><i class="fas fa-lock-open text-success"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
            ...
            <div class="modal-content">
                <form id="user_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>PHOTO</label>
                            <input type="photo" id="photo" name="photo" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>STATUS</label>
                            <input type="status" id="status" name="status" class="form-control" required>
                        </div>
                    </div>
    ...
    <div id="addModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= site_url('user/tambahData') ?>" enctype="multipart/form-data">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <!-- <input type="text" name="id_role" id="id_role" class="form-control"></input> -->
                            <label for="exampleFormControlSelect1">Example select</label>
                            <select name="id_role" id="id_role" class="form-control" id="exampleFormControlSelect1">

                                <?php foreach ($role as $j) { ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            //                     '<td>' + '<img src="' + response[i].photo + '" alt="test">' + '</td>' +
